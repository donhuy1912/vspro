...
from userdetail.models import LessonReply, Enrollment, Lesson, Chapter, Subject, Account
...
def create(request):
    ...
    return render(request, 'lessonreply/lessonreply_create.html', context)
...
def edit(request, id):
    ...
    return render(request, 'lessonreply/lessonreply_edit.html', context)
