...
from userdetail.models import ProjectShareReply, ProjectShare, Account
...
def create(request):
    ...
    return render(request, 'projectsharereply/projectsharereply_create.html', context)
...
def edit(request, id):
    ...
    return render(request, 'projectsharereply/projectsharereply_edit.html', context)
