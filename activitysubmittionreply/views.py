...
from userdetail.models import ActivitySubmittionReply, Enrollment, ActivitySubmittion, Chapter, Lesson, Item, Activity, Subject, Account
...
def create(request):
    if request.method == 'POST':
        activitysubmittionreply = ActivitySubmittionReply( 
                                ...
                                activitysubmittionid = ActivitySubmittion.objects.get(activitysubmittionid = request.POST['submittionid']),
    ...
    return render(request, 'activitysubmittionreply/activitysubmittionreply_create.html', context)
...
def edit(request, id):
    ...
    return render(request, 'activitysubmittionreply/activitysubmittionreply_edit.html', context)
