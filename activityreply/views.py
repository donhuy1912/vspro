...
from userdetail.models import ActivityReply, Enrollment, Activity, Lesson, Chapter, Item, Account, Subject
...
def index(request):
    ...
    for activityreply in activityreply:
...
def create(request):
    ...
    return render(request, 'activityreply/activityreply_create.html', context)
...
def edit(request, id):
    ...
    return render(request, 'activityreply/activityreply_edit.html', context)
