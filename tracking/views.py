...
from userdetail.models import Tracking, Enrollment, Subject, SubjectPart, Chapter, Lesson, Item, Activity, Account
...
def create(request):
    ...
    return render(request, 'tracking/tracking_create.html', context)
...
def edit(request, id):
    ...
    return render(request, 'tracking/tracking_edit.html', context)
