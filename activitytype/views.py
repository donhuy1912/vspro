...
from userdetail.models import ActivityType
...
def create(request):
    if request.method == 'POST':
        ...
        # activitytypeid = request.POST['activitytypeid'],
    return render(request, 'activitytype/activitytype_create.html')
...
def edit(request, id):
    ...
    return render(request, 'activitytype/activitytype_edit.html', context)
