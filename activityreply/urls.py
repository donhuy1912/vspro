...
urlpatterns= [
    ...
    url(r'^activityreply/delete/(?P<id>\d+)$', views.delete, name='delete'),
    url(r'^activityreply/edit/(?P<id>\d+)$', views.edit, name='edit'),
    url(r'^activityreply/edit/update/(?P<id>\d+)$', views.update, name='update'),
    url(r'^activityreply/create$', views.create, name='create'),
