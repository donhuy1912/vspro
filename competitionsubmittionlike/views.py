...
from userdetail.models import CompetitionSubmittionLike, CompetitionSubmittion, Account, Competition
...
def index(request):
    ...
    for competitionsubmittionlike in competitionsubmittionlikes:
        competitionsubmittionlike.createdate = competitionsubmittionlike.createdate
        competitionsubmittionlike.editdate = competitionsubmittionlike.editdate
...
def create(request):
    ...
    return render(request, 'competitionsubmittionlike/competitionsubmittionlike_create.html', context)
...
def edit(request, id):
    ...
    return render(request, 'competitionsubmittionlike/competitionsubmittionlike_edit.html', context)
