...
from userdetail.models import SubjectPart, Subject, Account
...
def index(request):
    ...
    return render(request, 'tables_object.html', context)
...
def create(request):
    ...
    return render(request, 'subjectpart/subjectpart_create.html', context)
...
def edit(request, id):
    ...
    return render(request, 'subjectpart/subjectpart_edit.html', context)
...
def update(request, id):
    ...
    subjectpart.createdate=subjectpart.createdate
    subjectpart.editdate=datetime.now()
    subjectpart.avatar=request.POST['avatar']
