...
from userdetail.models import SubjectLike, Subject, Account, Subject
...
def create(request):
    ...
    return render(request, 'subjectlike/subjectlike_create.html', context)
...
def edit(request, id):
    ...
    return render(request, 'subjectlike/subjectlike_edit.html', context)
