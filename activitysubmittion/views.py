...
from userdetail.models import ActivitySubmittion, Activity, Account, Chapter, Lesson, Item, Subject
...
def create(request):
    ...
    return render(request, 'activitysubmittion/activitysubmittion_create.html', context)
...
def edit(request, id):
    ...
    return render(request, 'activitysubmittion/activitysubmittion_edit.html', context)
